...
public class LightsTest {
	...
	public void SpotLightSphereTest() {
		...
		scene.addLightSorce(
				new SpotLight(new Color(400, 200, 200), new Point3D(0, 0, 0), 1, 0.004, 0.004, new Vector(1, -1, 2)));
	...
	public void SpotLightTrianglesTest() {
		...
		scene.addLightSorce(
				new SpotLight(new Color(400, 200, 200), new Point3D(0, 0, 0), 1, 0.004, 0.004, new Vector(0, 0, 1)));
		Render render = new Render(imageWriter, scene);
	...
	public void DirectionalLightTrianglesTest() {
		...
		scene.addLightSorce(new DirectionalLight(new Color(400, 200, 200), new Vector(0, 0, 1)));
		Render render = new Render(imageWriter, scene);
