...
public class IntegrationCamera {
	...
	public void testIntefretion() {
		...
		int counter;
		Sphere sphere = new Sphere(new Color(0,0,0),1,new Point3D(0,0,-3));
		counter = findNumberIntersection(sphere,ray);
		assertEquals("Fail intersect correct",2,counter);
		counter = 0;
		sphere = new Sphere(new Color(0,0,0),2.4,new Point3D(0,0,-2.5));
		counter = findNumberIntersection(sphere,ray);
		assertEquals("Fail intersect correct",18,counter);
		counter = 0;
		sphere = new Sphere(new Color(0,0,0),1.5,new Point3D(0,0,-2));
		counter = findNumberIntersection(sphere,ray);
		assertEquals("Fail intersect correct",10,counter);
		counter = 0;
		sphere = new Sphere(new Color(0,0,0),5,new Point3D(0,0,-2.5));
		counter = findNumberIntersection(sphere,ray);
		assertEquals("Fail intersect correct",9,counter);
		sphere = new Sphere(new Color(0,0,0),1,new Point3D(0,0,1));
		counter = findNumberIntersection(sphere,ray);
		assertEquals("Fail intersect correct",0,counter);
		Plane plane = new Plane (new Color(0,0,0),new Point3D(0,0,-1),new Point3D(0,1,-1),new Point3D(1,0,-1));
		counter = findNumberIntersection(plane,ray);
		assertEquals("Fail intersect correct",9,counter);
		plane = new Plane (new Color(0,0,0),new Point3D(0,0,-1),new Point3D(0,1,-1),new Point3D(1,0,-0.5));
		counter = findNumberIntersection(plane,ray);
		assertEquals("Fail intersect correct",9,counter);
		plane = new Plane (new Color(0,0,0),new Point3D(0,0,-1),new Point3D(0,1,1),new Point3D(1,0,-1));
		counter = findNumberIntersection(plane,ray);
		assertEquals("Fail intersect correct",6,counter);
		Triangle triangle = new Triangle(new Color(0,0,0),new Point3D(0,-1,-2),new Point3D(1,1,-2),new Point3D(-1,1,-2));
		counter = findNumberIntersection(triangle,ray);
		assertEquals("Fail intersect correct",1,counter);
		triangle = new Triangle(new Color(0,0,0),new Point3D(0,-20,-2),new Point3D(1,1,-2),new Point3D(-1,1,-2));
		counter = findNumberIntersection(triangle,ray);
		assertEquals("Fail intersect correct",2,counter);
	}
